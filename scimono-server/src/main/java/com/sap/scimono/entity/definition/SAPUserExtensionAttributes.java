...
public enum SAPUserExtensionAttributes implements ScimAttribute<SAPUserExtensionAttributes> {
    ...
    CONTACT_PREFERENCES(CONTACTPREFERENCES_FIELD, null),
    CONTACT_PREFERENCES_DESCRIPTION(CONTACTPREFERENCES_DESCRIPTION_FIELD, CONTACT_PREFERENCES),
    CONTACT_PREFERENCES_EMAIL(CONTACTPREFERENCES_EMAIL_FIELD, CONTACT_PREFERENCES),
    CONTACT_PREFERENCES_TELEPHONE(CONTACTPREFERENCES_TELEPHONE_FIELD, CONTACT_PREFERENCES),

    SOCIAL_IDENTITIES(SOCIALIDENTITIES_FIELD, null),
    SOCIAL_IDENTITIES_SOCIAL_ID(SOCIALIDENTITIES_SOCIALID_FIELD, SOCIAL_IDENTITIES),
    SOCIAL_IDENTITIES_SOCIAL_PROVIDER(SOCIALIDENTITIES_SOCIALPROVIDER_FIELD, SOCIAL_IDENTITIES),
    SOCIAL_IDENTITIES_DATE_OF_LINKING(SOCIALIDENTITIES_DATEOFLINKING_FIELD, SOCIAL_IDENTITIES),

    PASSWORD_DETAILS(PASSWORDDETAILS_FIELD, null),
    PASSWORD_DETAILS_LOGINTIME(PASSWORDDETAILS_LOGINTIME_FIELD, PASSWORD_DETAILS),
    PASSWORD_DETAILS_FAILEDLOGINATTEMPTS(PASSWORDDETAILS_FAILEDLOGINATTEMPTS_FIELD, PASSWORD_DETAILS),
    PASSWORD_DETAILS_SETTIME(PASSWORDDETAILS_SETTIME_FIELD, PASSWORD_DETAILS),
    PASSWORD_DETAILS_STATUS(PASSWORDDETAILS_STATUS_FIELD, PASSWORD_DETAILS),
    PASSWORD_DETAILS_POLICY(PASSWORDDETAILS_POLICY_FIELD, PASSWORD_DETAILS),
    ...
    PHONE_NUMBERS(PHONENUMBERS_FIELD, null),
    PHONE_NUMBERS_TYPE(PHONENUMBERS_TYPE_FIELD, PHONE_NUMBERS),
    PHONE_NUMBERS_VALUE(PHONENUMBERS_VALUE_FIELD, PHONE_NUMBERS),
    PHONE_NUMBERS_DISPLAY(PHONENUMBERS_DISPLAY_FIELD, PHONE_NUMBERS),
    PHONE_NUMBERS_PRIMARY(PHONENUMBERS_PRIMARY_FIELD, PHONE_NUMBERS);
    ...
    public static SAPUserExtensionAttributes from(String attributeName) {
        return SAP_EXTENSION_ATTRIBUTES_FACTORY.from(attributeName);
    }
