...
public class AttributeAndValueValidatorTest {
  ...
  public void testValidate() {
    ...
    new AttributeAndValueValidator(mainAttribute, Collections.emptyMap()).validate(value);
  }
  ...
  public void testValidateDataType() {
    ...
    assertThrows(PatchValidationException.class, () -> new AttributeAndValueValidator(mainAttribute, Collections.emptyMap()).validate(value));
  }
