...
public class UsersEndpointContainingUsersCondition implements ExecutionCondition {
  ...
  public ConditionEvaluationResult evaluateExecutionCondition(final ExtensionContext context) {
    ...
    if (backendCheck.isUsersEndpointEmpty()) {
      return ConditionEvaluationResult.disabled("Backend system has users alredy created.");
    }

    return ConditionEvaluationResult.enabled("Backend system has no users created.");
  }
}
